...
Специально, чтобы ответить на этот вопрос и рассказать историю создания Data Learn мы записали подкаст:![[1_Откуда_взялся_Data_Learn_и_почему_он_бесплатный.mp3]]
