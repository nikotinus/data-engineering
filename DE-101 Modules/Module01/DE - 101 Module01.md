...
[[Users/alex/code/data-engineering/notes/1.1|Заметки]]
...
[[Users/alex/code/data-engineering/notes/1.5|Заметки]]
## 1.6: Два типа инженера данных
[[Users/alex/code/data-engineering/notes/1.6|Заметки]]
...
Чтобы построить такое решение, нужен Инженер Данных. В моем случае это не просто создание потока данных, трансформация и загрузка данных. Это полноценная работа с бизнес-подразделениями, понимание их нужд и предоставление им инструментов для решения их задач. 
